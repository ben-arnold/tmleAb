...
fit_iadj <- agecurveAb(Y=di$logpftitre,Age=di$ageyrs,id=di$id,
                       ...
                       SL.library=mylib)
```
Although the cross-validated MSE ("risk") is slightly lower after adjusting for the additional covariates, the mean age-antibody relationship is remarkably similar after adjustment.
