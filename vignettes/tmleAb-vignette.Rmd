...
author: "vignette for version 0.3.4"
date: "`r Sys.Date()`"
output: 
  html_document:
    theme: default
...
* `family` : An optional model family for continuous (`gaussian`) or binary (`binomial`) outcomes (default is `family='gaussian'`).
