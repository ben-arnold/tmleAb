...
#'
#' @format A data frame with 771 observations and 12 variables.
#' \describe{
#'  \item{\code{id}}{individual ID}
#'  \item{\code{sampleid}}{specimen ID}
#'  \item{\code{agem}}{age in months}
#'  \item{\code{agey}}{age in years}
...
#' @keywords datasets
#'
#' @seealso \code{\link{usa_enterics}}
#'
#' @references K. L. Hamlin et al., Longitudinal monitoring of the development of antifilarial antibodies and acquisition of Wuchereria bancrofti in a highly endemic area of Haiti. PLoS Negl. Trop. Dis. 6, e1941 (2012).
